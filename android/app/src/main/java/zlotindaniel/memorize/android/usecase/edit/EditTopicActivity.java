package zlotindaniel.memorize.android.usecase.edit;
...
import zlotindaniel.memorize.usecase.edit.EditTopicInteractor;
...
public class EditTopicActivity extends BaseActivity {
	...
	protected void onCreate(@Nullable final Bundle savedInstanceState) {
		...
		setContentView(view);
		interactor = new EditTopicInteractor(topic, view, new DatabaseService(config.debug, getUserDetails().getId(), config.database));
		interactor.start();
	}
